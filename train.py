...
from book_data_utils import is_cleaned_data_saved, cleaning_data, data_iterator
...
ap.add_argument("-d", "--dataset", type=str, default="book",
                help="Dataset string.")
...
if DATASET == 'book':
    NUMCLASSES = 10
    if not is_cleaned_data_saved():
        print('It takes a while to clean the data and convert ISBN to Id and then save them in different file')
...
support = sp.hstack(support, format='csr')  # 6040 x 18530
support_t = sp.hstack(support_t, format='csr')  # 3706 x 30200
